...
library(datasetTRES)
IP.file = c("cb_6wk_ip_rep1_chr19", "cb_6wk_ip_rep2_chr1_chr19")
...
IP.file = c("cb_6wk_ip_rep1_chr19.bam", "cb_6wk_ip_rep2_chr19.bam")
Input.file = c("cb_6wk_input_rep1_chr19.bam", "cb_6wk_input_rep2_chr19.bam")
BamDir = file.path(system.file(package = "datasetTRES"), "inst/extdata/")
OutDir = YourOutputDir
TRES_peak(IP.file = IP.file,
          Input.file = Input.file,
          genomeBuild = "mm9",
